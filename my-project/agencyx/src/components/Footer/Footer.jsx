...
// If images in src/assets/:
import GasFooterLogo from '../../assets/GasFooterLogo.png'; //gas footer
        ...
        <div className=' w-full col-span-2 flex items-center justify-center'>
          <div className="flex flex-col items-center md:items-start pb-4 gap-6 w-full">
            <div className="flex items-center gap-2">
              <img src={GasLogo} alt="AgencyX Logo" width={107} height={36} className="mb-2" />
            </div>
            ...
            <div className="flex items-center gap-2 mt-2 mb-2">
              <img src={GasFooterLogo} alt="GAS Logo" width={90} height={30} />
            </div>
            <div className="border-t border-gray-700 w-[220px] my-2"></div>
                ...
                <li key={idx}>
                  {typeof link === 'string' ? (
                    ...
                    <a href="#" className="hover:text-blue-400 transition-colors cursor-pointer">
                      {link.text}
                      {link.span ? <span className="bg-[#659BFF] text-xs text-white rounded-full px-2 py-1 ml-2">{link.span}</span> : null}
                    </a>
                  )}
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-[15px]">
              ...
              <li className="flex items-center gap-2">
                <a className="hover:text-blue-400 transition-colors cursor-pointer">Careers</a>
                <span className="bg-[#659BFF] text-xs text-white rounded-full px-2 py-1">Hiring</span>
              </li>
            </ul>
          </div>
        </div>
