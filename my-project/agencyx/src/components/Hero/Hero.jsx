...
import HeroImage from "../../assets/HeroImage.png"; // works in CRA or Vite if configured properly
          ...
          <div className="relative z-10 flex flex-col items-center gap-12 w-full px-4">
            ...
            <div className="relative w-full max-w-4xl mx-auto sm:[box-shadow:_0px_-80px_75px_-75px_rgba(34,18,133,0.8),30px_-20_30px_-5px_rgba(157,18,164,0.5)] rounded-2xl">
              <img
                ...
                width={1200}
                height={500}
                className="relative z-10 w-full h-auto rounded-2xl border-t border-l border-r border-[rgba(53,51,116,0.8)] hover:scale-105 transition-all duration-500"
              />
            </div>
          </div>
        </div>
